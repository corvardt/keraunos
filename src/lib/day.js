...
// rate, four of burn, twelve of clustering, an hour of history. None of them
// can show the thing lightning does most reliably, which is a daily cycle. The
...
//
// Nothing new is stored to get it. A strike costs about 64 bytes and the
// history already holds 120,000 of them; what is kept here is one count per
// minute, and a day is 1,440 counts. The strikes themselves are not retained
// past the hour they were always retained for, which is why this is a curve and
// not a longer rewind: it can say how hard the world was firing at four this
// morning, and nothing whatever about where.
//
