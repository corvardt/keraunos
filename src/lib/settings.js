...
export const DEFAULTS = {
  ...
  //
  // One of them starts folded. Eight open groups is the whole column on the
  // first screen with no way in to it, and Reach is the one a first minute
  // needs least: it is a reading about the ionosphere rather than about the
  // weather, and it is empty until a couple of hundred strikes have been filed.
  // It is one keypress from open and stays open once opened, which is the
  // difference between this and hiding it.
  //
  // Session was folded here too and is not any more. It was tall while it held
  // the session total; the total has gone up to Rate, where it is read against
  // the figure it belongs with, and what is left is a 44px curve and a line
  // saying where the peak was. A fold over that costs a click to save nothing,
  // and folded by default it left a heading that appeared to hold nothing at
  // all.
  shut: { reach: true },
  // panel
  feed: true,
