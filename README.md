...
| **Coverage** | The live rate held against 44 flashes a second, which is every flash the planet makes, as measured from orbit. The bar is not meant to reach it: this network hears cloud-to-ground strokes, and only about a quarter of the world's lightning reaches the ground at all |
...
| **Map** | Cell bounds, graticule, frontiers, daylight, capitals, detector threads, imager coverage, how long a strike stays lit |
...
MTG-I Lightning Imager. The borrowed phosphor palettes are credited in
`src/lib/palette.js`.
